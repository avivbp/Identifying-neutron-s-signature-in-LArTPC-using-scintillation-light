  ...
  fParticle(0), fEkin(0.)
{
  ...
  csvfi.open("tofCal.csv");
  csvfi << "t0" << "," << "t1" << "," << std::endl;
  csvfi.close();

  csvfi.open("eventType.csv");
  csvfi << "eventID" << "," << "Type" << "," << std::endl;
  csvfi.close();

  csvfi.open("DecayTime.csv");
  csvfi << "eventID" << "," << "time" << "," << std::endl;
  csvfi.close();
  ...
  csvfi.open("gammaE.csv");
  csvfi << "eventID" << "," << "gammaE" << "," << std::endl;
  csvfi.close();
  ...
  csvfi << "eventID" << "," << "numPhotons" << "," << "numUp" << "," << "numDown" << "," << "coincidenceTime" << "," << "numElasticSensitive" << "," << "scatteredInelastically" << "," << "scatteredNotSensitive" << "," << "nucleusRecoilEnergy" << "," << "timeOfFlight" << "," << "t1" << "," << "t0" << "," << std::endl;
  csvfi.close();
  ...
  csvfi << "eventID" << "," << "experimentalRecoilEnergy" << "," << "timeOfFlight" << "," << std::endl;
  csvfi.close();
