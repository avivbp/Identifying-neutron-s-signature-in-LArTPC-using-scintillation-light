...
{ 
 ...
 // fSolidAbsorber = new G4Box("Absorber",        
  ...
  std::vector<G4double> pp = {9.6*eV, 9.7*eV};
  ...
  G4double rotationAngle = pi/2 - 0.5236;
  ...
  G4ThreeVector position2 = G4ThreeVector(1.*m,0,0);
  std::cout << "position before rotation = " << position2 << std::endl;
  position2 = rotateAroundY(position2,0.5236);
