...
# plt.ylabel('count')
# plt.title('num photons created by Am gamma ray in LAr')
# plt.show()
#
# print("gaussian H + A * np.exp(-(x - x0) ** 2 / (2 * sigma ** 2))\n with params H = ", parameters[0][0], ", A = ",
#       parameters[0][1], ", $\mu$ = ", miu, ", $\sigma$ = ", sigma)
...
#     # plt.plot(sim_E, sim_pe, '.', label='Darkside_fit simulation with kB = 0.1')
#     plt.plot(cr_E, electron_pes, '.', color='royalblue', markersize=15, label='Darkside_fit simulation with kB = 0.1')
...
# data = pd.read_csv("../Scintillation_Data/Creus/60deg_data.csv")
...
#
# dat = pd.read_csv("../Scintillation_Data/Creus/neutron_sim_results/lightYield_60deg_optical_tof.csv")
#
# num_up = dat.numUp
...
#                yscale=1)
#
# dat = pd.read_csv("../Scintillation_Data/Creus/neutron_sim_results/lightYield_0.1_birks_60deg_1_fano.csv")
# num_up = dat.numUp
# num_down = dat.numDown
# num_pes = num_up + num_down
#
...
# # plt.xlim([0, 42])
# plt.legend()
# plt.title('number of p.e following 60 degree neutron scatter off LAr')
# plt.show()
#
